...
@RequestMapping("/api/v1/nomenclature/object-type")
public class ObjectTypeController extends CrudController<String, ObjectTypeDTO> {

    private final ObjectTypeService service;

    @Override
    protected CrudServiceBase<String, ObjectTypeDTO> getService() {
        return service;
    }
