...
@RequestMapping("/api/v1/nomenclature/agent-status")
public class AgentStatusController extends CrudController<Integer, AgentStatusDTO> {
    ...
    @Override
    protected CrudServiceBase<Integer, AgentStatusDTO> getService() {
