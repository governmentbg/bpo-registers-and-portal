...
--changeset raneva:0132 splitStatements:false
drop view eservices.application_summary_view;
...
create or replace view eservices.application_summary_view
            (id, registration_number, object_type_name, object_type_code, applicant, created_date, submit_type_name,
             submit_type_code, study_type, created_user, created_org_user, updated_user, filing_date)
as
SELECT asy.id,
