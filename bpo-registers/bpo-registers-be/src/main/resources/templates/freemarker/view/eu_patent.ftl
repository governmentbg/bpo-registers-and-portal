...
<#--    <#include "../sections/ipobjects/patentlike/common/citations_data.ftl"/>-->
    <#include "../sections/ipobjects/patentlike/common/cpc_data.ftl"/>
    <#include "../sections/ipobjects/patentlike/common/ipc_data.ftl"/>
    <#include "../sections/ipobjects/common/publications_data.ftl"/>
    <#include "../sections/ipobjects/patentlike/common/abstract_data.ftl"/>
