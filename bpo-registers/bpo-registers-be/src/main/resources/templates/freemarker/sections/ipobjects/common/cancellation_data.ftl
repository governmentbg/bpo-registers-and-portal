...
<#escape x as x?html>
    <div class="page-unbreakable">
        <@sectionHeading 'l.section.cancellation.data'/>
        <#if cancellations?? && cancellations?has_content>
            <div>
                <table class="table table-striped mt-3">
                    <thead>
                    <tr>
                        <th><@label "l.table.head.cancellation.recordalType"/></th>
                        <th><@label "l.table.head.recordalNumber"/></th>
                        <th><@label "l.table.head.status"/></th>
                    </tr>
                    </thead>
                    <tbody>
                    <#list cancellations as r>
                        <tr>
                            <td>
