...
@RequestMapping("/api/v1/nomenclature/country")
public class CountryController extends CrudController<String, CountryDTO> {
    ...
    @Override
    protected CrudServiceBase<String, CountryDTO> getService() {
