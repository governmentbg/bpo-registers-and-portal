...
import bg.duosoft.bpo.registers.mapper.ipobject.search.UtilityModelFilterDetailsMapper;
...
@IpObjectGroup
@RestController
@Api(tags = Tags.UTILITY_MODELS)
@RequestMapping(value = {"/api/v1/utility-models"})
@RequiredArgsConstructor
public class UtilityModelController {
    ...
    @PostMapping
    public Page<IpObjectSearchResult> search(@RequestBody UtilityModelFilterDetailsDTO filter){
        IpObjectFilter searchRequiredFilter = utilityModelFilterDetailsMapper.toIpObjectFilter(filter);
