...
import bg.duosoft.bpo.registers.mapper.ipobject.search.PatentFilterDetailsMapper;
...
@IpObjectGroup
@RestController
@Api(tags = Tags.PATENTS)
@RequestMapping(value = {"/api/v1/patents"})
...
public class PatentController {
    ...
    @PostMapping
    public Page<IpObjectSearchResult> search(@RequestBody PatentFilterDetailsDTO filter) {
        IpObjectFilter searchRequiredFilter = patentFilterDetailsMapper.toIpObjectFilter(filter);
