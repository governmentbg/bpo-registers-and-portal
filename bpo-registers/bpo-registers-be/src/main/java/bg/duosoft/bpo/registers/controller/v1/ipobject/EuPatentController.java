...
import bg.duosoft.bpo.registers.mapper.ipobject.search.EuPatentFilterDetailsMapper;
...
@IpObjectGroup
@RestController
@Api(tags = Tags.EU_PATENTS)
@RequestMapping(value = {"/api/v1/eu-patents"})
@RequiredArgsConstructor
public class EuPatentController {
    ...
    @PostMapping
    public Page<IpObjectSearchResult> search(@RequestBody EuPatentFilterDetailsDTO filter){
        IpObjectFilter searchRequiredFilter = euPatentFilterDetailsMapper.toIpObjectFilter(filter);
